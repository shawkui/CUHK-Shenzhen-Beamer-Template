...
%%%%%%%%%%%%% 中文适配 %%%%%%%%%%%%%%%%%
% 在menu中切换compiler为XeLaTex

% 中文字体与预览 https://www.cnblogs.com/wodedow/p/13845213.html
\usepackage{xeCJK}
\newcommand{\fonta}{\CJKfamily{font01}}
\setCJKfamilyfont{font01}{FandolFang}
